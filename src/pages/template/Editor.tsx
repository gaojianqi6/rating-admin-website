...
export function TemplateEditorPage() {
  ...
  // const [templateData] = useState(STATIC_TEMPLATE_DATA);
  const { data: templateData } = useQuery({
    queryFn: () => getTemplate(1),
    queryKey: "[query/template]",
    initialData: STATIC_TEMPLATE_DATA as Template,
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("Form submitted (static demo, no changes saved)");
  };
